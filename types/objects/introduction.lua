---INTRODUCTION - Introducao (ABNT)
---Per ABNT NBR 14724:2011 - first textual chapter
...
M.object = {
    ...
    description = "Introducao - introduction chapter (ABNT)",
    extends = "TEXTUAL",
...
---Render introduction with odd page break.
...
function M.on_render_SpecObject(obj, ctx)
    ...
    local level = 1
    local title = obj.title_text or "Introdução"
