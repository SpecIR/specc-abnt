...
local function find_render_script(speccompiler_home)
    ...
    local function add_ts_paths(prefix)
        -- The renderer is model-owned: it ships inside the charts model.
        table.insert(candidates, {path = prefix .. "/models/abnt/tools/" .. RENDER_SCRIPT, compiled = false})
...
return {
    ...
    schema = {
        ...
        counter_group = "CHART",      -- Separate counter from FIGURE (NBR: Gráficos)
