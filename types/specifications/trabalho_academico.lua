...
return {
    ...
    schema = {
        ...
        attributes = {
            ...
            { name = "nature", type = "STRING", required = false, label = "Natureza", description = "Natureza do trabalho" },
            { name = "preamble", type = "STRING", required = false, label = "Preâmbulo", description = "Texto completo de apresentação do trabalho" },
            { name = "program", type = "STRING", required = false, label = "Programa", description = "Programa de pós-graduação" },
            { name = "program_acronym", type = "STRING", required = false, label = "Sigla do programa", description = "Sigla do programa de pós-graduação" },
            { name = "cover_note", type = "STRING", required = false, label = "Nota da capa", description = "Nota curta exibida na capa gráfica" },
            { name = "concentration_area", type = "STRING", required = false, label = "Área de concentração", description = "Área de concentração do trabalho" },
            { name = "version_note", type = "STRING", required = false, label = "Versão", description = "Nota de versão exibida nos elementos pré-textuais" },
            { name = "degree", type = "STRING", required = false, label = "Título", description = "Título acadêmico pretendido" },
